 ...
 * The type student
 */
public class Student extends com.flipkart.bean.User {

    private List<com.flipkart.bean.Course>mainCourseList;
...
//    }
     ...
     */
    public List<com.flipkart.bean.Course> getMainCourseList() {
