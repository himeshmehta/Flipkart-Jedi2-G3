...
public interface CourseRegistrationInterface {
     ...
     *
     ...
     @returns - Boolean
     **/
    Boolean registerCourse(Student student, String courseId) throws CourseRegistrationException;
     ...
     *
     ...
     @returns - Boolean
     **/
    Boolean removeCourse(Student student, String courseId) throws CourseRegistrationException;
     ...
     *
     ...
     @returns - Boolean
     **/
    Boolean addCourse(Student student, String courseId) throws CourseRegistrationException;
