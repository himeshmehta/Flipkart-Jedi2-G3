...
public class CourseRegistrationServices implements CourseRegistrationInterface{
    ...
    @Override
    public Boolean registerCourse(Student student, String courseId) throws CourseRegistrationException {
        logger.info("Registering for the course");
        return courseDBOperations.registerStudent(student,courseId);
        }

    @Override
    public Boolean removeCourse(Student student, String courseId) throws CourseRegistrationException{
        logger.info("Removing the course");
        return courseDBOperations.removeStudent(student,courseId);
        }

    @Override
    public Boolean addCourse(Student student, String courseId) throws CourseRegistrationException{
