...
public interface CourseDBInterface {
     ...
     * @return Boolean
     */
    public  Boolean registerStudent(Student student , String courseId) throws CourseRegistrationException;
     ...
     * @return Boolean
     */
    public  Boolean removeStudent (Student student , String courseId) throws CourseRegistrationException;
     ...
     * @return Boolean
     */
    public  Boolean addStudent (Student student , String courseId) throws CourseRegistrationException;
